    ...
    <div class="row">
        <div class="col-6">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php for ($x = 0; $x < sizeof($products_data); $x++) {
                    echo"<tr><td>$products_data[product_id]</td><td>$products_data[product_name]</td>
                          <td>$products_data[brand]</td>
                          <td>$products_data[type]</td>
                          <td>$products_data[product_barcode]</td>
                          <td>$products_data[product_weight]</td>
                          </tr>";
                    }
                    ?>
                </tbody>
